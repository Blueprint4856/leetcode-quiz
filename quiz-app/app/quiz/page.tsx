      ...
      <div className="min-h-screen bg-[#e8f5f0] p-4 flex items-center justify-center">
        <div className="max-w-md w-full animate-bounce-in">
          <Card variant="elevated" className="text-center bg-white shadow-lg border border-gray-200">
            ...
            {/* Score Display */}
            <div className="my-8 p-6 bg-emerald-50 rounded-2xl border-2 border-emerald-200">
              <div className="text-7xl font-extrabold text-emerald-600 mb-3">
            ...
            <div className="space-y-3">
              <Button
                size="lg"
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold shadow-lg"
              ...
              <Button
                variant="secondary"
                size="lg"
                className="w-full font-semibold border-2 border-gray-300 hover:border-emerald-400 hover:bg-emerald-50"
                onClick={() => router.push('/')}
              >
                <span className="flex items-center justify-center gap-2">
                  Back to Home 🏠
    ...
    <div className="min-h-screen bg-[#e8f5f0] p-4 pb-8">
      <div className="max-w-2xl mx-auto pt-4">
        ...
        <div className="mb-6 space-y-4 animate-slide-up">
          <div className="flex items-center justify-between">
            <Button
              variant="ghost"
              size="sm"
              className="bg-white hover:bg-gray-50 font-semibold text-gray-700 shadow-sm border border-gray-200"
              onClick={() => {
        ...
        <div className="mb-5 text-center animate-slide-up">
          <div className="inline-block px-6 py-3 bg-white rounded-2xl shadow-sm border border-gray-200">
        ...
        <div className="text-center">
          <div className="inline-block px-5 py-2 bg-white rounded-full shadow-sm border border-gray-200">
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-[#e8f5f0] p-4 flex items-center justify-center">
        <div className="text-center">
          <div className="text-6xl mb-4 animate-bounce">🎯</div>
          <div className="animate-spin rounded-full h-16 w-16 border-4 border-emerald-200 border-t-emerald-600 mx-auto mb-6" />
          <p className="text-2xl font-bold text-emerald-600">Loading quiz...</p>
        </div>
      </div>
    }>
      <QuizPageContent />
